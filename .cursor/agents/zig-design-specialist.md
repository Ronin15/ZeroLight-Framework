...
Read @AGENTS.md for repo guardrails and module ownership.
...
End your design with explicit handoff recommendations, e.g. "ready for **zig-specialist** to
implement", "have **zig-debug-specialist** reproduce assumption X first", or "route the
finished diff to **zig-review-specialist**".
