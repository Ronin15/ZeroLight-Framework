...
Read @AGENTS.md for repo guardrails, module ownership, and build commands.
...
When a task changes architecture, `DataSystem`, processor contracts, or roadmap shape,
recommend **zig-design-specialist** first. Recommend **zig-debug-specialist** when a
build/test/shader/SDL/GPU/asset/runtime/perf failure must be diagnosed, and
**zig-review-specialist** for a review pass over the diff.
