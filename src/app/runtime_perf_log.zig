...
const EnabledRuntimePerfLog = struct {
    ...
    fn emit(self: *const EnabledRuntimePerfLog, elapsed_ns: u64) void {
        ...
        log.debug(
            "perf {d:.1}s events total={} dropped={} created={} destroyed={} component_changed={} world_tile_changed={} world_obstacle_changed={} nav_invalidated={} entity_perceived={} entity_lost={} structural_stage={} domain_stage={}",
            .{
                elapsed_s,
