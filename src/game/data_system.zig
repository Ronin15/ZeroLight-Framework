...
pub const MovementSteeringDenseIndices = @import("data_system/types.zig").MovementSteeringDenseIndices;
...
pub const ai_memory_familiarity_gain_rate = @import("data_system/types.zig").ai_memory_familiarity_gain_rate;
pub const max_ai_commitment_max_steps = @import("data_system/types.zig").max_ai_commitment_max_steps;
